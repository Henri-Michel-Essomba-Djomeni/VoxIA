...
| R-014 | Texte OCR sensible exposé via presse-papiers ou partage | Élevé | Moyen | Actions copie/partage explicites, avertissement UI avant bouton, partage via chooser Android | En réduction |
