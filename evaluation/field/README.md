...
- `checklists/phone_real_smoke.csv` : cas manuels prioritaires pour téléphone réel.
- `reports/.gitkeep` : conserve le dossier de sortie local sans committer les rapports.

## Règle

Les rapports terrain peuvent contenir des informations d'appareil, de logs ou de contexte utilisateur. Ne pas les committer sans anonymisation et validation de gouvernance.
